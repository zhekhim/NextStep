  ...
  Future<void> _save() async {
    ...
    try {
      await _repository.updateProfile(
        ...
        targetedJobRoles: widget.profile.targetedJobRoles,
      );
      if (mounted) {
        Navigator.pop(
          context,
      ...
      body: Form(
        ...
        child: ListView(
          ...
          children: [
            ...
            if (widget.profile.targetedJobRoles.isNotEmpty) ...[
              const SizedBox(height: 16),
              TextFormField(
                initialValue: widget.profile.targetedJobRoles.first,
                readOnly: true,
                decoration: _decoration(
                  'Targeted Job Role',
                  helperText: 'This is managed from your active career goal.',
                ),
              ),
            ],
            const SizedBox(height: 16),
